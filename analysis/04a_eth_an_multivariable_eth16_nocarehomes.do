/*==============================================================================
DO FILE NAME:			04a_eth_an_multivariable_eth16_nocarehomes
...
/* Estout================================================================*/ 
esttab model1 model2 model3 model4 model5 using ./output/estout_table2_eth16.txt, b(a2) ci(2) label wide compress eform ///
	title ("`i'") ///
	varlabels(`e(labels)') ///
	stats(N_sub) ///
	append 
...
outsheet using ./output/FP_multivariable_eth16.txt, replace
