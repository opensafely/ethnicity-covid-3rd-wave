...
study = StudyDefinition(
   ...
   population=patients.registered_with_one_practice_between(
    ...
    dereg_date=patients.date_deregistered_from_all_supported_practices(
        on_or_before="2021-04-30", 
        date_format="YYYY-MM",
        return_expectations={"date": {"earliest": "2021-01-01"}},
    ...
    covid_admission_date=patients.admitted_to_hospital(
        ...
        find_first_match_in_period=True,  
        date_format="YYYY-MM-DD",  
        return_expectations={"date": {"earliest": "2021-01-01"}, "incidence" : 0.25},
   ),
    ...
    gp_consult_count=patients.with_gp_consultations(
        ...
        return_expectations={
            ...
            "date": {"earliest": "2019-03-01", "latest": "2020-12-31"},
            "incidence": 0.7,
        },
    ),
    has_consultation_history=patients.with_complete_gp_consultation_history_between(
        "2020-01-01", "2020-12-31", return_expectations={"incidence": 0.9},
    ),
    ...
    bmi=patients.most_recent_bmi(
        between=["2010-09-01", "2020-12-31"],
        minimum_age_at_measurement=16,
        include_measurement_date=True,
        include_month=True,
        return_expectations={
            "date": {"earliest": "2010-09-01", "latest": "2020-12-31"},
    ...
    chronic_respiratory_disease=patients.with_these_clinical_events(
        ...
        include_month=True,
        return_expectations={"date": {"latest": "2020-12-31"}},
    ),
    ...
    asthma=patients.categorised_as(
        ...
        recent_asthma_code=patients.with_these_clinical_events(
            asthma_codes, between=["2018-01-01", "2020-12-31"],
        ),
...
#EXETER ALGORITHM USING EXETER CODELISTS
    ...
    temporary_immunodeficiency=patients.with_these_clinical_events(
        combine_codelists(aplastic_codes,
                temp_immune_codes),
        between=["2020-01-01", "2020-12-31"], ## THIS IS RESTRICTED TO LAST YEAR
        return_last_date_in_period=True,
        include_month=True,
        return_expectations={
            "date": {"earliest": "2020-01-01", "latest": "2020-12-31"}
